...
<html lang="en">
	...
	<body>
	  ...
	  echo "<div style='font-size:26px;color:white;'>繳費金額：".$sqd["money"]."</div>";
      echo "<div style='font-size:18px;color:white; margin-top: 15px;'>超商繳費代碼：</div>";
      echo "<div style='font-size:28px;color:#f39c12;font-weight:bold;letter-spacing:2px; margin-top: 10px;'>".$PaymentNo."</div>";
      if($ExpireDate) echo "<div style='font-size:18px;color:white; margin-top: 15px;'>請在繳費期限 <span style='color: #f39c12;'>".$ExpireDate."</span> 前繳款</div>";
	  ...
	  echo "<div style='font-size:18px;color:white; margin-top: 15px;'>7-11 ibon 代碼：</div>";
      echo "<div style='font-size:28px;color:#f39c12;font-weight:bold;letter-spacing:2px; margin-top: 10px;'>".$PaymentNo."</div>";
      if($ExpireDate) echo "<div style='font-size:18px;color:white; margin-top: 15px;'>請在繳費期限 <span style='color: #f39c12;'>".$ExpireDate."</span> 前繳款</div>";
